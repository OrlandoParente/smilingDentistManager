...
- The [first client](https://github.com/OrlandoParente/smilingDentistManager/tree/main/smilingDentinstManagerClient) is and desktop application written with Swing. In future probably I will re-writing it with Java FX.
  To date I *do not* raccomend to use this client, cause it miss some functionality.
