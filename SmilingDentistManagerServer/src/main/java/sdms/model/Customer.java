...
public class Customer {
	...
	public Customer(int id, String taxIdCode, String name, String surname, String birthCity, String birthCityProvince,
			String birthDate, String residenceStreet, String residenceCity, String residenceProvince,
	...
	public String toString() {
		return "Customer [id=" + id + ", taxIdCode=" + taxIdCode + ", name=" + name + ", surname=" + surname
				...
				+ ", residenceStreet=" + residenceStreet + ", residenceCity=" + residenceCity + ", residenceProvince="
				+ residenceProvince + ", phoneNumber=" + phoneNumber + ", phoneNumber2=" + phoneNumber2 + ", eMail="
				+ eMail + "]";
	}
